    ...
    <div className="flex flex-col md:flex-row">
      <div className="p-7 border-b-2 md:border-r-2 md:min-h-screen">
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
          ...
          <button className="bg-blue-500 text-white p-3 rounded-lg uppercase hover:opacity-95">
            Search
          </button>
        </form>
      </div>
      ...
      <div className="flex-1">
        <h1 className="text-3xl font-semibold border-b p-3 text-slate-900 mt-5">
          Listing results
        </h1>
        <div className="p-7 flex-wrap gap-4">
          {!loading && listings.length === 0 && (
            <p className="text-xl text-slate-900 p-7"> No listings found</p>
          )}
          {loading && (
          ...
          <div className="flex flex-wrap gap-4">
            ...
            {showmore && (
              <button
                className="text-green-600 underline p-7 text-center w-full"
